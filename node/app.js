...
var count = 0;
var finalresult = "";
var questions = ["What is your opinion of the condition of the classrooms?",
"What is your opinion of the cleanliness of the toilets?",
"What is your opinion of the availability of parking spaces?",
"What is your opinion of the air conditioning inside the buildings?",
"What is your opinion of the health care in the university?",
"What is your opinion of the food served by the university cafeterias?",
"What is your opinion of the services of the library?"];

var questions2 = ["What else can you say about the condition of the classrooms? Please elaborate your experience.",
"What else can you say about the cleanliness of the toilets? Please elaborate your experience.",
"What else can you say about the availability of parking spaces? Please elaborate your experience.",
"What else can you say about the air conditioning inside the buildings? Please elaborate your experience.",
"What else can you say about the health care in the university? Please elaborate your experience",
"What else can you say about the food served by the university cafeterias? Please elaborate your experience.",
"What else can you say about the services of the library? Please elaborate your experience."];
...
natural_language_understanding.analyze(parameters, function(err, response) {
  ...
  //  console.log('error:', err);
    ...
    if(b){
     ...
     message: {
       text: 'Error in text please try to Clarify your response',
       metadata: "DEVELOPER_DEFINED_METADATA"
     }
   };
   ...
   message: {
     text: questions2[count-1],
     metadata: "DEVELOPER_DEFINED_METADATA"
   }
 };
nextq = questions2[count-1];
 callSendAPI(messageData);
 return;
}
  }
    ...
    switch (count) {
      ...
      case 4:
      case 5:
      case 6: msg = questions[count];
      nextq = questions[count];
      break;
      case 7: console.log(finalresult);
      default: msg = "Thank you we're done with our Chatbot survey, you can move to the next one.";
      break;
    }
    count++;
